...
rawWordList = jieba.cut(rawText)

# Construct List of Phrases and Preliminary wordList
phraseList = [""]
wordList = []
for eachWord in rawWordList:
    if eachWord not in swLibList and notNumStr(eachWord):
